...
RUNNER_CACHE_DIR = "/content/cache/"
...
class Task2Runner(TaskRunner):
    def __init__(
        ...
        super().__init__(langs, splits, model_name, cache_dir=cache_dir, perform_early_setup=perform_early_setup, checkpoint_path="/content/drive/MyDrive/full-tuned-xglm-models/models/checkpoint-5500")
    ...
    for dim_reduction in ["t-SNE", "PCA"]:
        for model_name in ["facebook/xglm-564M"]:
            ...
            for layer in range(0, runner.num_layers + 1):
                ...
                plotter = Task2Plotter(runner, layer=layer, cache_dir=RUNNER_CACHE_DIR, plots_folder="/content/plots")
